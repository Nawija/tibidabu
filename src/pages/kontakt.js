    ...
    return (
        <Layout>
            ...
            <section className="flex flex-col lg:flex-row items-start justify-center mx-auto my-6 lg:my-10 max-w-screen-xl px-6">
                ...
                <div class="text-gray-700 bg-blue-50 border-2 border-yellow-400 lg:order-2 shadow-lg py-6 sm:py-8 lg:py-12 body-font relative w-full lg:w-1/2 mx-auto px-6 rounded-lg">
                                ...
                                <div class="p-2 w-1/2">
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            id="name"
                                            name="name"
                                            class="w-full bg-gray-100 bg-opacity-50 rounded-lg border border-blue-400 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                        />
                                    </div>
                                </div>
                                <div class="p-2 w-1/2">
                                ...
                                <div class="p-2 w-full">
                                    <div class="relative">
                                        ...
                                        <textarea
                                            id="message"
                                            name="message"
                                            class="w-full bg-gray-100 bg-opacity-50 rounded-lg border border-blue-400 focus:ring-2 focus:ring-blue-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                                        ></textarea>
                                    </div>
                                </div>
                                <div class="p-2 w-full">
                                    <button className="flex ml-auto py-2 font-medium bg-[#5271FF] text-white px-4 rounded-lg w-max">
                                        Wyślij
                                    </button>
                                </div>
                            </div>

...
const OfertaPage = () => {
    return (
        <Layout>
            ...
            <div class="container mx-auto md:px-6 relative">
                <section>
                    <div class="grid px-6 md:px-12 lg:grid-cols-3 xl:px-32">
                        <div class="p-0 py-12">
                            <div class="block h-full rounded-lg border bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] lg:rounded-tr-none lg:rounded-br-none">
                                <div class="border-b-2 border-neutral-100 border-opacity-100 p-6 text-center dark:border-opacity-10">
                                    ...
                                    <h3 class="mb-6 text-3xl">
                                        <strong>$ 129</strong>
                                        <small class="text-base text-neutral-500 ">
                                            /year
                                        </small>
                                    </h3>

                                    <div className="h-[1px] rounded-lg w-3/4 bg-gray-500 mx-auto mt-10" />
                                </div>
                                <div class="p-6">
                                ...
                                justify-center py-2 font-medium bg-[#5271FF]
                                text-white px-4 rounded-lg w-max mx-auto mb-12"
                                >
                                    Zarezerwuj
                                </Link>
                            </div>
                        ...
                        <div className="z-[1]">
                            <div class="block h-full rounded-lg bg-blue-50 border-2 border-yellow-400 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
                                <div class="border-b-2 border-neutral-100 border-opacity-100 p-6 text-center dark:border-opacity-10">
                                    <p class="mb-4 text-sm uppercase">
                                    ...
                                    <div className="h-[2px] rounded-lg w-3/4 bg-yellow-400 mx-auto mt-10" />
                                </div>
                                <div class="p-6">
                                    <ol class="list-inside">
                                        <li class="mb-4 flex">
                        ...
                        <div class="py-12">
                            <div class="block h-full rounded-lg border bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] lg:rounded-tl-none lg:rounded-bl-none">
                                <div class="border-b-2 border-neutral-100 border-opacity-100 p-6 text-center dark:border-opacity-10">
                                    <p class="mb-4 text-sm uppercase">
            ...
            <div class="bg-white py-6 sm:py-8 lg:py-12 max-w-screen-xl mx-auto">
                <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <h2 class="mb-4 text-center text-2xl font-bold text-[#5271FF] changeColor md:mb-8 lg:text-3xl xl:mb-12">
                        Nasze Opinie
                    </h2>
